...
return [
    ...
    'check_slug' => 'Vérifier',
    'url_notice' => 'L\'URL créée par défaut reprend le nom de votre agence, mais si vous le souhaitez, vous pouvez renseigner une URL spécifique.',
    ...
    'valid_platform_creation' => 'Valider',
